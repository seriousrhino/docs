...
description: "Configure LM Studio to run local LLMs with Oryx"
icon: "desktop"
---
...
<Steps>
  ...
  <Step title="Configure in Oryx">
    ...
    <Frame>
      ![Configure in Oryx](/images/setting-up-lm-studio/lmstudio-step3.png)
    </Frame>
  ...
  <Step title="Use the Model">
    ...
    <Frame>
      ![Use the model in Oryx](/images/setting-up-lm-studio/lmstudio-step5.png)
    </Frame>
