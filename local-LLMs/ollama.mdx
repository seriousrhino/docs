...
Navigate to the Oryx AI settings page at `chrome://settings/browseros-ai`
...
Run Ollama with the required CORS settings to allow Oryx to connect:
...
<Note>
  Unfortunately, Ollama by default doesn't allow requests from other apps
...
<Frame>![Use the model](/images/setting-up-ollama/ollama-step4.png)</Frame>
